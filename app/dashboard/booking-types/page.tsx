...
export default function BookingTypesPage() {
    ...
    return (
        <div className="animate-fade-in">
            <div
                className="booking-types-header"
                style={{
                    display: "flex",
            ...
            >
                ...
                <Link href="/dashboard/booking-types/new" className="btn-primary" style={{ alignSelf: "stretch", justifyContent: "center" }}>
            ...
            {bookingTypes.length === 0 ? (
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                    {bookingTypes.map((type) => (
                        <div
                            key={type.id}
                            className="glass-card booking-type-card"
                            style={{
                                padding: "24px 28px",
                                display: "flex",
                                justifyContent: "space-between",
                        ...
                        >
                            <div style={{ flex: "1 1 360px" }} className="booking-type-content">
                                <div
                                    style={{
                                        display: "flex",
                                        alignItems: "center",
                                ...
                                <div
                                    ...
                                    className="booking-type-info-row"
                                >
                            ...
                            <div
                                ...
                                className="booking-type-actions"
                            >
