...
export default function StepConnectCalendar({
  onConnect,
  onSkip,
  onBack,
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">
          Sync your availability so clients can book the right slots.
        </p>
      </div>
      ...
      <button
        onClick={onConnect}
        className="w-full flex items-center justify-center gap-3 px-4 py-4 rounded-xl border border-gray-200 bg-white text-sm font-medium text-gray-700 hover:border-gray-900 hover:bg-gray-50 transition"
      >
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <p className="text-xs text-gray-400 text-center">
          You can always connect it later from your dashboard.
        </p>
      </div>
