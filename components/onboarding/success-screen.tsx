  ...
  return (
    <div className="flex flex-col items-center gap-6 text-center">
      ...
      <div className="w-full flex items-center gap-2 px-4 py-3 rounded-xl bg-gray-50 border border-gray-200">
        <p className="flex-1 text-sm font-medium text-gray-700 break-all text-left">
          {bookingLink}
        </p>
        <button
          onClick={handleCopyLink}
          title="Copy link"
          className="shrink-0 p-1.5 rounded-lg hover:bg-gray-200 transition text-gray-400 hover:text-gray-700"
        >
          {copiedLink ? (
      ...
      <div className="flex flex-col gap-2 w-full">
        ...
        <a
          ...
          className="w-full px-4 py-3 rounded-xl bg-gray-900 text-sm font-medium text-white hover:bg-gray-800 transition text-center block"
        >
          Open booking page
        </a>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-gray-200 text-sm font-medium text-gray-600 hover:bg-gray-50 transition"
        >
        ...
        <button
          ...
          className="w-full px-4 py-3 rounded-xl border border-gray-900 text-sm font-medium text-gray-900 hover:bg-gray-900 hover:text-white transition mt-1"
        >
          Go to Dashboard →
        </button>
      </div>
